...
module.exports = {
  ...
  activity_public: {
    visible: {
      //可见不可见
      url: _base2.default.Config.server.ajax + 'visible_set_status.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    get_checking_channels_cities: {
      //获取用户管理的频道和城市及其对应的状态
      url: _base2.default.Config.server.ajax + 'get_checking_channels_cities.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    set_checking_channels_cities: {
      //根据传过来的参数添加抽取
      url: _base2.default.Config.server.ajax + 'set_checking_channels_cities.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    get_multiple: {
      //获取混排列表
      url: _base2.default.Config.server.ajax + 'get_multiple.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    set_multiple: {
      //设置混排列表
      url: _base2.default.Config.server.ajax + 'set_multiple.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    clear_multiple: {
      //清除混排列表
      url: _base2.default.Config.server.ajax + 'clear_multiple.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    }
  ...
  user: {
    login: {
      url: _base2.default.Config.server.ajax + 'userLogin.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    getCodeKey: {
      url: _base2.default.Config.server.ajax + 'get_captcha_key.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    }
  ...
  biguser: { //壹点号相关接口
    ...
    list: { //壹点号
      ...
      reset: { url: _base2.default.Config.server.ajax + "resetUserPwd.do" }, //重置壹点号密码
    ...
    type: { //壹点号的类型
      ...
      reset: { url: _base2.default.Config.server.ajax + "removeChannelType.do" }, //恢复壹点号类型
  ...
  activity: {
    add: {
      url: _base2.default.Config.server.ajax + 'activity_add.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    del: {
      url: _base2.default.Config.server.ajax + 'activity_delete.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    reset: {
      url: _base2.default.Config.server.ajax + 'activity_reset.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    save: {
      url: _base2.default.Config.server.ajax + 'activity_save.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    edit: {
      url: _base2.default.Config.server.ajax + 'activity_update.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    list: {
      url: _base2.default.Config.server.ajax + 'activity_list.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {
        pageIndex: 1,
    ...
    activity_list_content: {
      //按照条件查找信息
      url: _base2.default.Config.server.ajax + 'activity_list_content.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    getActivityList_id: {
      //按照id查找信息
      url: _base2.default.Config.server.ajax + 'activity_list_id.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    get_activity_in_post: {
      //获取活动列表及其关联帖子的情况
      url: _base2.default.Config.server.ajax + 'get_activity_in_post.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    activity_get_star_list: {
      //获取可排序的帖子列表
      url: _base2.default.Config.server.ajax + 'activity_get_star_list.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    activity_star_list: {
      //设置列表顺序
      url: _base2.default.Config.server.ajax + 'activity_star_list.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    commodity_star_remove: {
      //从精选列表中移除
      url: _base2.default.Config.server.ajax + 'activity_remove_from_star.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    activity_list_detail: {
      //查看详情
      url: _base2.default.Config.server.ajax + 'activity_list_detail.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    }
  ...
  commodity: { //商品列表
    add: {
      url: _base2.default.Config.server.ajax + 'commodity_add.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    edit: { //更新商品
      url: _base2.default.Config.server.ajax + 'commodity_update.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    detail: {
      url: _base2.default.Config.server.ajax + 'commodity_detail.do', //url
      authId: '', //控制权限
      method: 'post' },
    list_detail: {
      //商品在列表页获取详情时返回的
      url: _base2.default.Config.server.ajax + 'commodity_list_detail.do', //url
      authId: '', //控制权限
      method: 'post' },
    del: { //下架商品
      url: _base2.default.Config.server.ajax + 'commodity_del.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    list: { //商品列表
      url: _base2.default.Config.server.ajax + 'commodity_list.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {
        pageIndex: 1,
    ...
    orders: {
      url: _base2.default.Config.server.ajax + 'commodity_order.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
    business_list: { //商家列表
      url: _base2.default.Config.server.ajax + 'buiness_list.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {
        pageIndex: 1,
    ...
    brand_list: {
      url: _base2.default.Config.server.ajax + 'brand_list.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {
        pageIndex: 1,
    ...
    quanzi_list: {
      url: _base2.default.Config.server.ajax + 'quanzi_list.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {
        pageIndex: 1,
    ...
    get_goods_in_post: {
      //按照id查找信息
      url: _base2.default.Config.server.ajax + 'get_goods_in_post.do', //url
      authId: '', //控制权限
      method: 'post', //回调
      defaultData: {}
    },
  ...
  serial: {
    gallery: { //轮播图接口
      add: {
        url: _base2.default.Config.server.ajax + 'gallery_new.do', //url
        authId: '', //控制权限
        method: 'post', //回调
        defaultData: {
          status: 1
      ...
      edit: { //编辑后更新
        url: _base2.default.Config.server.ajax + 'gallery_update.do', //url
        authId: '', //控制权限
        method: 'post', //回调
        defaultData: {}
      },
      del: { //删除
        url: _base2.default.Config.server.ajax + 'gallery_delete.do', //url
        authId: '', //控制权限
        method: 'post', //回调
        defaultData: {}
      },
      gallery_get_list: { //返回轮播图列表
        url: _base2.default.Config.server.ajax + 'gallery_get_list.do', //url
        authId: '', //控制权限
        method: 'post', //回调
        defaultData: {
          pageIndex: 1,
      ...
      gallery_get_details: { //获取某条轮播图详情
        url: _base2.default.Config.server.ajax + 'gallery_get_details.do', //url
        authId: '', //控制权限
        method: 'post', //回调
        defaultData: {}
      ...
      orders: { //将设置好的顺序传递给后台
        url: _base2.default.Config.server.ajax + 'gallery_order_star.do', //url
        authId: '', //控制权限
        method: 'post', //回调
        defaultData: {}
      },
      gallery_set_status: { //设置状态
        url: _base2.default.Config.server.ajax + 'gallery_set_status.do', //url
        authId: '', //控制权限
        method: 'post', //回调
        defaultData: {}
      },
      gallery_filter_type_list: { //根据类型获取对应类别的列表
        url: _base2.default.Config.server.ajax + 'gallery_filter_type_list.do', //url
        authId: '', //控制权限
        method: 'post', //回调
        defaultData: {
          pageSize: 10,
      ...
      gallery_order_clear: { //清除已经排序的列表
        url: _base2.default.Config.server.ajax + 'gallery_order_clear.do', //url
        authId: '', //控制权限
        method: 'post', //回调
        defaultData: {}
      },
      gallery_get_order_list: { //获取可排序列表
        url: _base2.default.Config.server.ajax + 'gallery_get_order_list.do', //url
        authId: '', //控制权限
        method: 'post', //回调
        defaultData: {}
      }
    ...
    olympic: {
      ...
      get_olympic_info: { //获取是否显示、链接地址
        url: _base2.default.Config.server.ajax + 'olympicurldetail.do', //url
        authId: '' },
      set_is_show_info: { //设置是否显示奥运滚动列表
        url: _base2.default.Config.server.ajax + 'olympicnewsenter_ishow.do', //url
        authId: '' },
      ...
      get_an_item: { //获取一项新闻详细内容
        url: _base2.default.Config.server.ajax + 'olympicnewsdetail.do', //url
        authId: '' },
      new_an_item: { //设置是否显示奥运滚动列表
        url: _base2.default.Config.server.ajax + 'newolympicnews.do', //url
        authId: '' },
      update_an_item: { //设置是否显示奥运滚动列表
        url: _base2.default.Config.server.ajax + 'updateolympicnews.do', //url
        authId: '' },
      update_refs_url: { //设置奥运模块链接地址
        url: _base2.default.Config.server.ajax + 'updateolympicurl.do', //url
        authId: '' },
      get_item_list: { //获取奥运新闻列表
        url: _base2.default.Config.server.ajax + 'olympicnews_list.do', //url
        authId: '' },
      del_an_item: { //删除奥运新闻
        url: _base2.default.Config.server.ajax + 'deleteolympicnews.do', //url
        authId: '' },
      get_rank_list: { //获取排序列表
        url: _base2.default.Config.server.ajax + 'get_olympicnews_order.do', //url
        authId: '' },
      save_rank_list: { //保存排序列表
        url: _base2.default.Config.server.ajax + 'olympicnews_order.do', //url
        authId: '' },
      clear_rank_list: { //清空排序列表
        url: _base2.default.Config.server.ajax + 'clear_olympicnews_order.do', //url
        authId: '' }
    }
  },
  public: {
